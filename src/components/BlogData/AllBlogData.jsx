    ...
    <div className='text-left relative w-full flex justify-center sm:px-4 items-center flex-wrap gap-4' >
      {
        userdata && userdata.map((e,i)=>(
          <div onClick={()=>blogOnclickFunction(e)} className='p-2 min-h-[400px] cursor-pointer  w-[300px] text-neutral-500 border border-stone-200 rounded-lg  text-left hover:scale-[1.02] transition-all duration-300 shadow-md hover:shadow-2xl'>
