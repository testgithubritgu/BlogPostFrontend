...
const CreateBlogNavigationBar = () => {
  ...
  return (
    ...
    className='flex bg-green-100 py-4 my-4 flex-col items-center justify-between  gap-3 h-fit w-full' >
      <button 
     
      onClick={()=>navigate("/user_create_blog/")} className='py-2   bg-blue-500 px-16 rounded-2xl cursor-pointer text-white font-medium text-[18px] tracking-widest  hover:bg-blue-300 hover:text-blue-500 transition-all duration-300'>CREATE BLOG📝</button>
