...
const UserCommentsPage = () => {
  ...
  useEffect(() => {
    ...
    const  requrl=window.location.href
      try {
        const res = await axios.post(`https://blogpostbackend-v0uv.onrender.com/blog/getbyid/${id}`,{requrl},{headers:{"authorization":"Bearer "+(localStorage.getItem("token")&&localStorage.getItem("token"))}});
